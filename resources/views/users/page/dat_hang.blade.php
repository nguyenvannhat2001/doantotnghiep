        ...
        <div class="row">
            <div class="col-sm-6">
                ...
                <div class="form-block">
                    ...
                    <input type="text" id="address" name="address" value="{{Auth::user()->diachi}}"  placeholder="Street Address" >
                </div>


                <div class="form-block">
                    <label for="phone">Điện thoại*</label>
                    <input type="text" id="phone" name="phone" value="{{Auth::user()->dienthoai}}" >
                </div>
                ...
                <div class="your-order">
                    ...
                    <div class="your-order-body" style="padding: 0px 10px">
                            ...
                            <!--  one item	 -->
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                       ...
                                       <span class="color-gray your-order-info">Đơn giá: {{ number_format($cart['item']['price']) }} đồng</span>
                                        <span class="color-gray your-order-info">Số lượng: {{$cart['qty']}}</span>
                                    </div>
                                </div>
                            <!-- end one item --> @php $totalPrice += $cart['item']['price'] * $cart['qty']; @endphp
                            @endforeach
                            @endif
                            </div>
                            <div class="clearfix"></div>
                        ...
                        <div class="your-order-item">
                            ...
                            <div class="pull-right"><h5 class="color-black">@if(Session::has('cart')){{ number_format($totalPrice) }} đ @else 0 đ @endif</h5></div>
                            <div class="clearfix"></div>
                        </div>
                    </div>
