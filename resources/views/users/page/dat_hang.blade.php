                ...
                <div class="your-order">
                    ...
                    <div class="your-order-body" style="padding: 0px 10px">
                        <div class="your-order-item">
                            ...
                            <!--  one item	 -->
                                <div class="media">
                                    <img width="25%" src="images/{{$cart['image']}}" alt="" class="pull-left">
                        ...
                        <div class="your-order-item">
                            ...
                            <div class="pull-right"><h5 class="color-black">@if(!empty($totalPrice)){{ number_format($totalPrice) }} đ @else 0 đ @endif</h5></div>
                            <div class="clearfix"></div>
                        </div>
                    </div>
